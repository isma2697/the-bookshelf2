<div class="panel-control">
    <div class="control">
        ...
        <a href="{{route('admin.books.index')}}" class="btn-panel bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-500 text-white font-bold py-2 px-5 rounded-md inline-flex items-center justify-center">Ir al panel
    ...
    <div class="control">
        ...
        <a href="{{route('admin.users.index')}}" class="btn-panel bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-500 text-white font-bold py-2 px-5 rounded-md inline-flex items-center justify-center">Ir al panel
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6 ml-2">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
        </svg>
        </a>
