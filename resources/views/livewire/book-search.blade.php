<div class="search-div w-full " x-data="{ isOpen: false }" @click.away="isOpen = false">
    <div class="space-y-7 w-full " >
        <div class="relative">
            <input type="text" @input="isOpen = true" class="form-input block w-full pl-10 pr-3 py-2 border rounded-md leading-5 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:border-blue-300 focus:shadow-outline-blue transition duration-150 ease-in-out" placeholder="Buscar libros..." wire:model.debounce.500ms="search">
